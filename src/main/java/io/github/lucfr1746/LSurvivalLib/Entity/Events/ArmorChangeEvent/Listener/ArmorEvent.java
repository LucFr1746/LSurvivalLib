...
public abstract class ArmorEvent extends Event implements Cancellable {
    ...
    /**
     * Gets whether this event is canceled. This is based off of the
    ...
    public enum ArmorAction {
        /**
         * When item is manually equipped or unequip.
         */
        CLICK,
        /**
        ...
        SHIFT_CLICK,
        /**
         * When an item is unequip through double click, which collect's it to the
         * cursor.
         */
        DOUBLE_CLICK,
        /**
        ...
        DROP,
        /**
         * When right-clicking an armor piece in the hot bar without the inventory
         * open to equip.
         */
        HOTBAR,
        /**
